...
public class PopUpActiveCutscene : MonoBehaviour
{
   ...
   public GameObject DialogSystemActive3;
    ...
    {
        //DialogueBoxCutsceneOut.OnActive += EnableDialogBoxOuter3;
        DialogueBoxCutsceneOut.OnActive += EnableDialogBoxOuter2;
        DialogueBoxCutsceneOut.OnActive += EnableDialogBoxOuter4;

       // DialogueBoxCutsceneOut.OnActive2 += Enable2DialogBoxOuter3;
        DialogueBoxCutsceneOut.OnActive2 += Enable2DialogBoxOuter2;
        DialogueBoxCutsceneOut.OnActive2 += Enable2DialogBoxOuter4;
