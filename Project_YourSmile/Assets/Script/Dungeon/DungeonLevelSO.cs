...
public class DungeonLevelSO : ScriptableObject
{
    ...
    #endregion
    #region Tooltip
    [Tooltip("Populate the list with the room templates that you want to be part of the level. You need to ensure that room templates are included for all room node types that are specified in the Room Node Graphs for the levels")]
    #endregion
    ...
    #endregion
    #region Tooltip
    [Tooltip("Populate this list with the room node graphs which shoul be randomly selected for the level")]
    #endregion
    ...
    private void OnValidate()
    {
        ...
        if (HelperUtilities.ValidateCheckEnumerableValues(this, nameof(roomNodeGraphList), roomNodeGraphList))
            return;
        //Check to make sure that room templates are specified for all the node types in
        //the specified node graphs

        //First check that north.south corridor, east/west corridor and entrance type have been specified
        bool isEWCorridor = false;
        bool isNSCorridor = false;
        bool isEntrance = false;

        //loop throuygh all room templates to check that this node type has been specified
        ...
        foreach(RoomNodeGraphSO roomNodeGraph in roomNodeGraphList)
        {
            ...
            foreach(RoomNodeSO roomNodeSO in roomNodeGraph.roomNodeList)
            {
                ...
                //Corridor and entrance already checked
