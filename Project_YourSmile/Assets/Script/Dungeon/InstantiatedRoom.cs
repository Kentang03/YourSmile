...
public class InstantiatedRoom : MonoBehaviour
{
    ...
    {
        if(collision.tag == GameSettings.playerTag && room != GameManager.Instance.GetCurrentRoom())
        {
    ...
    private void AddObstaclesAndPreferredPaths()
    {
        ...
        for(int x = 0; x < (room.templateUpperBounds.x - room.templateLowerBounds.x + 1); x++)
        {
            ...
            {
                aStarMovementPenalty[x, y] = GameSettings.defaultAStarMovementPenalty;
                ...
                {
                    aStarMovementPenalty[x,y] = GameSettings.preferredPathAStarMovementPenalty;
                }
            }
        }
    }
    ...
    private void AddDoorsToRooms()
    {
        ...
        foreach(Doorway doorway in room.doorWayList)
        {
            ...
            {
                float tileDistance = GameSettings.tileSizePixels / GameSettings.pixelPerUnit;
